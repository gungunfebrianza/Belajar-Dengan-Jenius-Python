...
class window(QWidget):  # TEST
    ...
    def event_set_item(self):
        self.tableWidget1.insertRow(0)  # Note : Table Start From 1
        ...
        self.tableWidget1.insertRow(1)
        self.tableWidget1.setItem(1, 0, QtWidgets.QTableWidgetItem("1,0"))
        self.tableWidget1.setItem(1, 1, QtWidgets.QTableWidgetItem("1,1"))
        self.tableWidget1.setItem(1, 2, QtWidgets.QTableWidgetItem("1,2"))
        self.tableWidget1.setItem(1, 3, QtWidgets.QTableWidgetItem("1,3"))
    ...
    def get_item(self):
        current_row = self.tableWidget1.rowCount()
        self.tableWidget1.insertRow(current_row)

        acc, ok = self.inputDialog1.getText(self, 'Input Dialog', 'What Account?')
        if ok:
            self.tableWidget1.setItem(current_row, 0, QtWidgets.QTableWidgetItem(acc))
